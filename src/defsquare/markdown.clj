...
(defn process
  "return a map with two keys `:metadata`, `:html` and `:hiccup` with respectively the meta found in the md file front-matter and the markdown content transformed to hiccup"
  [md-string]
